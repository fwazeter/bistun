...
/// # let profile = LocaleProfile { id: "ja-JP".to_string(), morph: MorphType::AGGLUTINATIVE, base_seg: SegType::CHARACTER, alt_seg: Some(SegType::DICTIONARY), direction: Direction::LTR, has_bidi: false, requires_shaping: false, plurals: vec![], unicode_blocks: vec![], normalization: NormType::NFC, transliteration: TransType::NONE, required_resource: None };
